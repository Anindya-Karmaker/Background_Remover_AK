...
#   pyinstaller --noconfirm BackgroundRemoverAK.spec
#
# Output:
#   macOS   -> dist/BackgroundRemoverAK.app  (+ dist/BackgroundRemoverAK/)
#   Windows -> dist/BackgroundRemoverAK/BackgroundRemoverAK.exe
#   Linux   -> dist/BackgroundRemoverAK/BackgroundRemoverAK
#
...
if sys.platform == "darwin":
    app = BUNDLE(
        ...
        name=f"{APP_NAME}.app",
        icon=ICON,
        bundle_identifier="com.anindyakarmaker.backgroundremoverak",
        info_plist={
